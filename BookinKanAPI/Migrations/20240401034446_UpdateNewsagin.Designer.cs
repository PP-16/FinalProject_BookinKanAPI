...
namespace BookinKanAPI.Migrations
{
    ...
    [Migration("20240401034446_UpdateNewsagin")]
    partial class UpdateNewsagin
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("BookinKanAPI.Models.Passenger", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            PassengerName = "Admin",
                            Password = "$2a$11$VllcuxHgUvH2re.SkAipo.Qwq3cenFl0kaT9w/al21hxLKxUZnqK2",
                            Phone = "0912345678",
                            RoleId = 1,
                            isUse = false
                        });
            ...
            modelBuilder.Entity("BookinKanAPI.Models.SystemSetting", b =>
                {
                    ...
                    b.Property<string>("ImageSlideSerialized")
                        .IsRequired()
                        .HasColumnType("nvarchar(max)");
